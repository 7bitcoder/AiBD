...
print(fig3)
```
![fig 1](AiBD/Regresja Liniowa/Documents/Figure_1.png)
```python
...
print(fig3_res)
```
![fig 1](AiBD/Regresja Liniowa/Documents/Figure_2.png)
```python
...
print(fig3_res)
```
![fig 1](AiBD/Regresja Liniowa/Documents/Figure_3.png)
```python
...
print(fig4)
```
![fig 1](AiBD/Regresja Liniowa/Documents/Figure_4.png)
